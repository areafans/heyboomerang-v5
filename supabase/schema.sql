...
CREATE TABLE tasks (
  ...
  contact_phone TEXT,
  contact_email TEXT,
  task_type TEXT NOT NULL CHECK (task_type IN ('follow_up', 'reminder', 'campaign', 'contact_crud', 'follow_up_sms', 'email_send_reply', 'reminder_call')),
  ...
  delivery_method TEXT CHECK (delivery_method IN ('sms', 'email', 'both', 'internal', 'phone')),
